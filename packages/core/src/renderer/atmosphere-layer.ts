...
const resolveSide = (mode: AtmosphereOptions['side']): Side => {
  if (mode === 'front') return FrontSide;
  if (mode === 'double') return DoubleSide;
  return BackSide;
};

const resolveBlending = (mode: AtmosphereOptions['blending']): Blending => {
...
export class AtmosphereLayer {
  ...
  public setSide(mode: AtmosphereOptions['side']): void {
    this.material.side = resolveSide(mode);
    this.material.needsUpdate = true;
  }

  public setBlending(mode: AtmosphereOptions['blending']): void {
   ...
   */
  public setPulse(pulse: AtmosphereOptions['pulse'] | null): void {
