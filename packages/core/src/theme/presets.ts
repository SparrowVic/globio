...
export const THEME_PRESETS: Readonly<Record<ThemePresetName, PartialTokenSet>> = Object.freeze({
  ...
  'cinematic-night': Object.freeze({
    ...
    'cinematic.oceanColor': '#010b14',
    'cinematic.landColor': '#8a5f32',
    'cinematic.cloudColor': '#c8f0ff',
    'cinematic.nightColor': '#020612',
    'cinematic.lightDirectionX': -0.68,
    'cinematic.lightDirectionY': 0.72,
    'cinematic.lightDirectionZ': 0.22,
    'cinematic.terminatorSoftness': 0.34,
    'cinematic.terminatorContrast': 1.58,
    'cinematic.keyIntensity': 1.54,
    'cinematic.fillIntensity': 0.1,
    'cinematic.rimColor': '#b9ecff',
    'cinematic.rimIntensity': 1.12,
    'cinematic.rimPower': 2.18,
    'cinematic.specularIntensity': 0.92,
    'cinematic.cityLightColor': '#ffd36a',
    'cinematic.cityLightIntensity': 1.18,
    'cinematic.networkColor': '#f7b84d',
    'cinematic.networkOpacity': 0.19,
