...
export interface WireframeLabelsLayerOptions {
 ...
 */
export class WireframeLabelsLayer {
  ...
  private halo: WireframeLabelsLayerOptions['halo'];
  ...
  public constructor(private readonly options: WireframeLabelsLayerOptions) {
   ...
   */
  public setHalo(halo: WireframeLabelsLayerOptions['halo'] | null): void {
