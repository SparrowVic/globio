...
export interface WireframeMarkersLayerOptions {
...
export class WireframeMarkersLayer {
  ...
  public constructor(options: WireframeMarkersLayerOptions) {
  ...
  public addMarker(marker: MarkerConfig): void {
    ...
    if (index === undefined) {
      throw new Error(`WireframeMarkersLayer: max markers (${this.maxMarkers}) reached`);
    }
