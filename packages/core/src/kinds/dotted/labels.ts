...
export interface DottedLabelsLayerOptions {
 ...
 */
export class DottedLabelsLayer {
  ...
  private halo: DottedLabelsLayerOptions['halo'];
  ...
  public constructor(private readonly options: DottedLabelsLayerOptions) {
   ...
   */
  public setHalo(halo: DottedLabelsLayerOptions['halo'] | null): void {
