...
export interface HologramLabelsLayerOptions {
 ...
 */
export class HologramLabelsLayer {
  ...
  private halo: HologramLabelsLayerOptions['halo'];
  ...
  public constructor(private readonly options: HologramLabelsLayerOptions) {
   ...
   */
  public setHalo(halo: HologramLabelsLayerOptions['halo'] | null): void {
