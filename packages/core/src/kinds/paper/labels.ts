...
export class PaperLabelsLayer {
  ...
  private halo: PaperLabelsLayerOptions['halo'];
  ...
  public constructor(private readonly options: PaperLabelsLayerOptions) {
   ...
   */
  public setHalo(halo: PaperLabelsLayerOptions['halo'] | null): void {
