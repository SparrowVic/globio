...
export interface PaperAtmosphereOptions {
...
const resolveSide = (mode: PaperAtmosphereOptions['side']): Side => {
  if (mode === 'front') return FrontSide;
  if (mode === 'double') return DoubleSide;
  return BackSide;
};

const resolveBlending = (mode: PaperAtmosphereOptions['blending']): Blending => {
  if (mode === 'normal') return NormalBlending;
  return AdditiveBlending;
};

export class PaperAtmosphereLayer {
  ...
  public constructor(options: PaperAtmosphereOptions) {
  ...
  public setSide(mode: PaperAtmosphereOptions['side']): void {
    this.material.side = resolveSide(mode);
    this.material.needsUpdate = true;
  }

  public setBlending(mode: PaperAtmosphereOptions['blending']): void {
   ...
   */
  public setPulse(pulse: PaperAtmosphereOptions['pulse'] | null): void {
