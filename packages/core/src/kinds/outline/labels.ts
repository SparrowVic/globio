...
export interface OutlineLabelsLayerOptions {
 ...
 */
export class OutlineLabelsLayer {
  ...
  private halo: OutlineLabelsLayerOptions['halo'];
  ...
  public constructor(private readonly options: OutlineLabelsLayerOptions) {
   ...
   */
  public setHalo(halo: OutlineLabelsLayerOptions['halo'] | null): void {
