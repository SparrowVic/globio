...
export interface OutlineAtmosphereOptions {
...
const resolveSide = (mode: OutlineAtmosphereOptions['side']): Side => {
...
export class OutlineAtmosphereLayer {
  ...
  public setSide(mode: OutlineAtmosphereOptions['side']): void {
