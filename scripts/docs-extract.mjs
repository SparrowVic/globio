// Extracts the public API surface of @globiojs/core (config keys, instance
...
export const OUTPUT_PATH = path.join(coreDir, 'docs', 'api.json');
...
export function extract() {
  ...
  return {
    ...
    kindDataLayers: Object.fromEntries(['outline', 'dotted', 'wireframe', 'hologram', 'paper', 'cinematic'].map((kind) => {
      const file = parseFile(path.join(coreSrc, 'kinds', kind, 'index.ts'));
